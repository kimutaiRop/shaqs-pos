...
const Sidebar = () => {
    ...
    return (
        <div className="flex flex-col justify-between h-full bg-accent ">
            <div className="col-span-1  h-full  flex flex-col py-2">
                <div className="flex flex-col items-center py-10">
                    <img src="/logo__white.png" className="w-full" />
                </div>
                <div className="pt-4 space-y-4 px-1">
                    <a
                        href="/"
                        className={`px-3 rounded hover:bg-[#fae886] flex py-2 items-center font-bold space-x-2 ${
                            path === "/" ? "bg-[#fae886]" : ""
                        }
                    `}
                    >
            ...
            <div className="w-full py-3">
                <button
                    onClick={logout}
                    className="flex w-full bg-accent px-2 py-1.5 rounded items-center space-x-2"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
